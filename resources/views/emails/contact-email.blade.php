                        ...
                        <tr>
                            <td class="align-center" width="100%">
                                <a href="{{ env('APP_URL')}}"><img
                                        src="{{asset('template/images/charles/logo/logo.png')}}"
                                        height="40" alt="Charles K"></a>
                            </td>
                        </tr>
                    </table>
                </div>
                        ...
                        <tr>
                            <td class="wrapper">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            <p>👋&nbsp; Notification de Charles K AGRO</p>
                                            
                                            <p> Informations : Vous avez reçu un message d'un client via la plateforme web. Ci dessous le contenu du message</p>
                                            
                                            <p>
                                                Expéditeur: <strong>{{$data['name']}} </strong><br>
                                                Téléphone: <strong>{{$data['phone']}} </strong><br>
